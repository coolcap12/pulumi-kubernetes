...
func NewIngressClass(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:networking.k8s.io/v1:IngressClass", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIngressClass(ctx *pulumi.Context,
	...
	var resource IngressClass
	err := ctx.ReadResource("kubernetes:networking.k8s.io/v1:IngressClass", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
