...
namespace Pulumi.Kubernetes.ApiExtensions.V1Beta1
{
    ...
    public partial class CustomResourceDefinition : KubernetesResource
    {
        ...
        public CustomResourceDefinition(string name, Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionArgs? args = null, CustomResourceOptions? options = null)
            : base("kubernetes:apiextensions.k8s.io/v1beta1:CustomResourceDefinition", name, MakeArgs(args), MakeResourceOptions(options, ""))
        {
        }
        internal CustomResourceDefinition(string name, ImmutableDictionary<string, object?> dictionary, CustomResourceOptions? options = null)
            : base("kubernetes:apiextensions.k8s.io/v1beta1:CustomResourceDefinition", name, new DictionaryResourceArgs(dictionary), MakeResourceOptions(options, ""))
        {
        }

        private CustomResourceDefinition(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("kubernetes:apiextensions.k8s.io/v1beta1:CustomResourceDefinition", name, null, MakeResourceOptions(options, id))
        {
        }

        private static Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionArgs? MakeArgs(Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionArgs? args)
        {
            args ??= new Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionArgs();
...
namespace Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1
{
    ...
    public class CustomResourceDefinitionArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.ApiExtensions.V1Beta1.CustomResourceDefinitionSpecArgs> Spec { get; set; } = null!;
